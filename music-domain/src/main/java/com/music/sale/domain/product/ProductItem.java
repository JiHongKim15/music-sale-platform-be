...
public class ProductItem {
  ...
  @Builder.Default Integer stockQuantity = 1;

  @Builder.Default ProductStatus status = ProductStatus.AVAILABLE;

  @Builder.Default Map<String, Object> attributes = Collections.emptyMap();

  String description;

  @Builder.Default Long viewCount = 0L;
}
