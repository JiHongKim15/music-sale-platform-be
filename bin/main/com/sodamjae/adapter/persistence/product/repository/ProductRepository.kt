...
import com.sodamjae.adapter.persistence.product.entity.ProductEntity
import com.sodamjae.adapter.persistence.product.enum.ProductCategoryEntity
import com.sodamjae.adapter.persistence.product.enum.ProductStatusEntity
...
interface ProductRepository : JpaRepository<ProductEntity, Long> {
    ...
    @Query("""
        ...
        AND p.status = com.sodamjae.adapter.persistence.product.enum.ProductStatusEntity.ACTIVE
    """)
    fun searchProducts(
