package com.sodamjae.adapter.persistence.store.repository

import com.sodamjae.adapter.persistence.store.entity.StoreEntity
...
interface StoreRepository : JpaRepository<StoreEntity, Long> {
    ...
    @Query("""
        ...
        AND s.status = com.sodamjae.adapter.persistence.store.entity.StoreEntity.StoreStatus.ACTIVE
    """)
