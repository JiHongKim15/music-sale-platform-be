...
class UserEntity(
    ...
    var userType: UserType? = null, // 구매자, 판매자, 둘다
    
    @Column(name = "preferred_categories", columnDefinition = "TEXT") 
    var preferredCategories: String? = null, // JSON 형태로 관심 카테고리 저장
    ...
    fun addSocialConnection(provider: SocialProvider, providerId: String, accessToken: String? = null) {
        val connection = UserSocialConnectionEntity(
            user = this,
            provider = provider,
