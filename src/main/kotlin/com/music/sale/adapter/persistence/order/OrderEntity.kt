...
class OrderEntity(
    ...
    @Embedded
    val payment: PaymentEmbeddable,

    @Embedded
    val shipping: ShippingEmbeddable
) {
    companion object {
        ...
        return Order.create(
            ...
            product = Product(
                ...
                category = com.music.sale.domain.category.Category(
                    id = 0L,
                    name = "",
                    type = com.music.sale.domain.category.CategoryType.PRODUCT,
                    parent = null,
                    path = "",
                    depth = 0,
                    isActive = true
            ...
            shipping = Shipping.create(
                ...
                shipping.trackingNumber?.let { updateTrackingNumber(Shipping.TrackingNumber(it)) }
            }
        )
    }
}
