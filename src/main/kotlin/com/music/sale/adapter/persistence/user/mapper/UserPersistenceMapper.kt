...
class UserPersistenceMapper {
    ...
    fun toDomain(entity: UserEntity): User {
        return User(
            ...
            nickname = if (entity.nickname.isNotBlank()) User.Nickname(entity.nickname) else null,
            role = entity.role,
    ...
    fun toUserOutput(entity: UserEntity, socialConnections: List<SocialConnectionOutput>): UserOutput {
        return UserOutput(
            id = entity.id!!,
            email = entity.email,
            name = entity.name,
            ...
            interestedCategories = null, // TODO: 관심 카테고리 구현
            createdAt = entity.createdAt,
            updatedAt = entity.updatedAt
        )
    }
