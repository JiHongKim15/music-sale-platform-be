...
class CartService(
    ...
    override fun getUserCart(userId: Long, pageable: Pageable): Page<CartOutput> {
        return cartPort.findByUserId(userId, pageable)
    }

    override fun addToCart(userId: Long, productId: Long, quantity: Int): CartOutput {
    ...
    override fun updateCartQuantity(userId: Long, productId: Long, quantity: Int): CartOutput {
        val existingCart = cartPort.findByUserIdAndProductId(userId, productId)
    ...
    override fun removeFromCart(userId: Long, productId: Long) {
