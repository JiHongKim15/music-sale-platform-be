...
interface WishlistPort {
     ...
     * 사용자의 찜 목록 조회
     */
    fun findByUserId(userId: Long, pageable: Pageable): Page<WishlistOutput>

    /**
     * 찜 목록 저장
     */
    fun save(userId: Long, productId: Long): WishlistOutput
     ...
     * 사용자와 상품으로 찜 목록 조회
     */
    fun findByUserIdAndProductId(userId: Long, productId: Long): WishlistOutput?
