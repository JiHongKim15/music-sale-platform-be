...
interface WishlistUseCase {
     ...
     * 사용자의 찜 목록 조회
     */
    fun getUserWishlist(userId: Long, pageable: Pageable): Page<WishlistOutput>

    /**
     * 상품 찜하기
     */
    fun addToWishlist(userId: Long, productId: Long): WishlistOutput
     ...
     * 상품이 찜 목록에 있는지 확인
     */
    fun isProductInWishlist(userId: Long, productId: Long): Boolean
} 
