...
class ProductService(
    ...
    override fun createProduct(input: CreateProductInput): ProductOutput {
        val productItem = productMapper.toDomain(input)
        return productMapper.toOutput(productPort.save(productItem))
    }
    ...
    override fun deleteProduct(id: Long): ProductOutput {
        val productItem = productPort.findById(id) ?: throw IllegalArgumentException("Product not found")
        productPort.delete(productItem)
        return productMapper.toOutput(productItem)
    }
