...
public class ProductItemEntity extends com.music.sale.adapter.persistence.common.BaseEntity {
    ...
    @jakarta.persistence.ManyToOne(fetch = jakarta.persistence.FetchType.LAZY)
    @jakarta.persistence.JoinColumn(name = "seller_id", nullable = false)
    @org.jetbrains.annotations.NotNull()
    private final com.music.sale.adapter.persistence.seller.entity.SellerEntity seller = null;
    @jakarta.persistence.ManyToOne(fetch = jakarta.persistence.FetchType.LAZY)
    @jakarta.persistence.JoinColumn(name = "store_id", nullable = false)
    @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public com.music.sale.adapter.persistence.seller.entity.SellerEntity getSeller() {
        return null;
    }
