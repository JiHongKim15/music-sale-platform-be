...
public class CategoryPersistenceAdapter implements com.music.sale.application.category.port.outport.CategoryPort {
    ...
    @java.lang.Override()
    @org.jetbrains.annotations.NotNull()
    public java.util.List<com.music.sale.domain.category.Category> findByType(@org.jetbrains.annotations.NotNull()
    ...
    @java.lang.Override()
    @org.jetbrains.annotations.NotNull()
    public java.util.List<com.music.sale.domain.category.Category> findRootCategories() {
        return null;
    }
    
    @java.lang.Override()
    @org.jetbrains.annotations.NotNull()
    public java.util.List<com.music.sale.domain.category.Category> findByParentId(long parentId) {
        return null;
    }
