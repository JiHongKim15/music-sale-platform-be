...
-- 상품 아이템 데이터 (실제 판매 상품)
INSERT INTO product_item (catalog_id, seller_id, store_id, price, condition, condition_grade, stock_quantity, status, custom_name, custom_attributes, created_at, updated_at, created_by, updated_by) VALUES (1, 1, 1, 1200000, 'USED', 'EXCELLENT', 1, 'ACTIVE', '펜더 스트라토캐스터 미국산', '{"color": "Sunburst", "year": "2020"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system');
INSERT INTO product_item (catalog_id, seller_id, store_id, price, condition, condition_grade, stock_quantity, status, custom_name, custom_attributes, created_at, updated_at, created_by, updated_by) VALUES (2, 1, 1, 900000, 'USED', 'VERY_GOOD', 1, 'ACTIVE', '펜더 재즈 베이스 4현', '{"color": "White", "year": "2019"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system');
INSERT INTO product_item (catalog_id, seller_id, store_id, price, condition, condition_grade, stock_quantity, status, custom_name, custom_attributes, created_at, updated_at, created_by, updated_by) VALUES (1, 1, 1, 800000, 'USED', 'GOOD', 1, 'ACTIVE', '펜더 스트라토캐스터 멕시코산', '{"color": "Black", "year": "2018"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'system', 'system');
