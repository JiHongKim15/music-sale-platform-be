            ...
            .orElseThrow(
                () ->
                    new IllegalArgumentException(
                        "User not found for UserTerms mapping: " + domain.getUserId()));
    ...
    UserEntity userEntity =
        userRepository
            ...
            .orElseThrow(
                () ->
                    new IllegalArgumentException(
                        "User not found for UserSocial mapping: " + domain.getUserId()));

    return UserSocialEntity.builder()
        .id(domain.getId())
        .user(userEntity)
        .provider(
            com.music.sale.persistence.user.enums.SocialProvider.valueOf(
