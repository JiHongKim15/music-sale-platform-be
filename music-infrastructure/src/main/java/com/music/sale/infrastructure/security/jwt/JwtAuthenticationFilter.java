...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  private void authenticateUser(String token, HttpServletRequest request) {
    ...
    com.music.sale.domain.user.enums.UserRole role =
        com.music.sale.domain.user.enums.UserRole.valueOf(roleStr);

    LoginUser loginUser = LoginUser.of(userId, email, nickname, role);
