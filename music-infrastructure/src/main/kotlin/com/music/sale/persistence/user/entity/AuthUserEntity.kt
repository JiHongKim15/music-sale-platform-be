...
class AuthUserEntity(
    ...
    @Column(name = "password_salt") var passwordSalt: String? = null,
    @Column(name = "failed_login_attempts") var failedLoginAttempts: Int = 0,
    @Column(name = "locked_until") var lockedUntil: LocalDateTime? = null,
    @Column(name = "password_changed_at")
    var passwordChangedAt: LocalDateTime = LocalDateTime.now(),
    @Column(name = "must_change_password") var mustChangePassword: Boolean = false,
    @Column(name = "two_factor_enabled") var twoFactorEnabled: Boolean = false,
    @Column(name = "two_factor_secret") var twoFactorSecret: String? = null,
    @Column(name = "backup_codes", columnDefinition = "TEXT") var backupCodes: String? = null,
) : BaseEntity() {
