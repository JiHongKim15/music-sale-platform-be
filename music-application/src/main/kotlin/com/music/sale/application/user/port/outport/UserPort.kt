...
interface UserPort {
    ...
    fun existsSocialConnection(
        userId: Long,
        provider: SocialProvider,
    ): Boolean

    fun deleteSocialConnection(
        userId: Long,
        provider: SocialProvider,
    )
    ...
    fun deletePhoneVerification(
        phoneNumber: String,
        verificationType: VerificationType,
    )

    fun markPhoneVerificationAsUsed(
        phoneNumber: String,
        verificationType: VerificationType,
    )
    ...
    fun updateUserZipcode(
        userId: Long,
        zipcode: String,
    )

    fun updateUserBaseAddress(
        userId: Long,
        baseAddress: String,
    )

    fun updateUserDetailAddress(
        userId: Long,
    ...
    fun updateUserPreferredPriceRangeMin(
        userId: Long,
        minPrice: Int,
    )

    fun updateUserPreferredPriceRangeMax(
        userId: Long,
        maxPrice: Int,
    )

    fun updateUserMarketingAgreed(
        userId: Long,
